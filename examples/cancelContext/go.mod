...
require (
	github.com/TrueBlocks/trueblocks-core/sdk/v3 v3.0.0-20240901041803-ae10d5f5adb1
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20240901041803-ae10d5f5adb1
)
