...
require (
	github.com/TrueBlocks/trueblocks-core/sdk/v3 v3.0.0-20240826114617-416b1f6dfe17
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20240826114617-416b1f6dfe17
)
