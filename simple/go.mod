...
require github.com/TrueBlocks/trueblocks-sdk/v3 v3.8.0

require (
	github.com/Microsoft/go-winio v0.6.1 // indirect
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20241103191228-02c20058347c // indirect
