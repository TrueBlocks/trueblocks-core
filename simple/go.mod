...
require github.com/TrueBlocks/trueblocks-sdk/v3 v3.5.5

require (
	github.com/Microsoft/go-winio v0.6.1 // indirect
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20241022031540-b362680128f7 // indirect
