...
CallSchema = schemas.AnyTypeSchema
ArticulateSchema = schemas.AnyTypeSchema
ProxyForSchema = schemas.AnyTypeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'call': typing.Union[CallSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        'proxyFor': typing.Union[ProxyForSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
...
request_query_call = api_client.QueryParameter(
    name="call",
    style=api_client.ParameterStyle.FORM,
    schema=CallSchema,
    explode=True,
...
request_query_proxy_for = api_client.QueryParameter(
    name="proxyFor",
    style=api_client.ParameterStyle.FORM,
    schema=ProxyForSchema,
    explode=True,
)
...
class ChainstateState(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def chainstate_state(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def chainstate_state(
        ...
        return self._chainstate_state_oapg(
