...
class CacheItem(
    ...
    a single entry in the results of a status query when `--verbose` is enabled
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            lastCached = schemas.AnyTypeSchema
            ...
            sizeInBytes = schemas.AnyTypeSchema
            __annotations__ = {
                "type": type,
                "items": items,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lastCached"]) -> MetaOapg.properties.lastCached: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nFiles"]) -> MetaOapg.properties.nFiles: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nFolders"]) -> MetaOapg.properties.nFolders: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "items", "lastCached", "nFiles", "nFolders", "path", "sizeInBytes", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lastCached"]) -> typing.Union[MetaOapg.properties.lastCached, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nFiles"]) -> typing.Union[MetaOapg.properties.nFiles, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nFolders"]) -> typing.Union[MetaOapg.properties.nFolders, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "items", "lastCached", "nFiles", "nFolders", "path", "sizeInBytes", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        lastCached: typing.Union[MetaOapg.properties.lastCached, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        nFiles: typing.Union[MetaOapg.properties.nFiles, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        nFolders: typing.Union[MetaOapg.properties.nFolders, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
