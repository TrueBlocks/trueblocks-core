...
class Timestamp(
    ...
    the timestamp, date and difference in timestamp of previous block produced by chifra when
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blockNumber", "timestamp", "date", "diff", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blockNumber", "timestamp", "date", "diff", ], str]):
