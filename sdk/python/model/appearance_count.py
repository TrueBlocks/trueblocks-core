...
class AppearanceCount(
    ...
    the number of records, file size, and last visited block for a given monitor
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nRecords"]) -> MetaOapg.properties.nRecords: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "nRecords", "fileSize", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nRecords"]) -> typing.Union[MetaOapg.properties.nRecords, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "nRecords", "fileSize", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        nRecords: typing.Union[MetaOapg.properties.nRecords, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        fileSize: typing.Union[MetaOapg.properties.fileSize, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'AppearanceCount':
        return super().__new__(
