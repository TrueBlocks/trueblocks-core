...
class MonitorClean(
    ...
    report on cleaning dups out of monitors
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            sizeThen = schemas.AnyTypeSchema
            sizeNow = schemas.AnyTypeSchema
            dups = schemas.AnyTypeSchema
            __annotations__ = {
                "address": address,
                "sizeThen": sizeThen,
                "sizeNow": sizeNow,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sizeThen"]) -> MetaOapg.properties.sizeThen: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sizeNow"]) -> MetaOapg.properties.sizeNow: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dups"]) -> MetaOapg.properties.dups: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "sizeThen", "sizeNow", "dups", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sizeThen"]) -> typing.Union[MetaOapg.properties.sizeThen, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sizeNow"]) -> typing.Union[MetaOapg.properties.sizeNow, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dups"]) -> typing.Union[MetaOapg.properties.dups, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "sizeThen", "sizeNow", "dups", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        sizeThen: typing.Union[MetaOapg.properties.sizeThen, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        sizeNow: typing.Union[MetaOapg.properties.sizeNow, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        dups: typing.Union[MetaOapg.properties.dups, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'MonitorClean':
        return super().__new__(
