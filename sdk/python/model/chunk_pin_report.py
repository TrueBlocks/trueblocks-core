...
class ChunkPinReport(
    ...
    a JSON object containing the results of pinning the Unchained Index
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tsHash"]) -> MetaOapg.properties.tsHash: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["manifestHash"]) -> MetaOapg.properties.manifestHash: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "chain", "schemas", "tsHash", "manifestHash", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tsHash"]) -> typing.Union[MetaOapg.properties.tsHash, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["manifestHash"]) -> typing.Union[MetaOapg.properties.manifestHash, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "chain", "schemas", "tsHash", "manifestHash", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        tsHash: typing.Union[MetaOapg.properties.tsHash, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        manifestHash: typing.Union[MetaOapg.properties.manifestHash, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ChunkPinReport':
        return super().__new__(
