...
class Abi(
    ...
    a JSON object describing the functions and events in an Ethereum smart contract
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            interfaces = schemas.AnyTypeSchema
            __annotations__ = {
                "address": address,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "interfaces", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "interfaces", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        interfaces: typing.Union[MetaOapg.properties.interfaces, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Abi':
        return super().__new__(
