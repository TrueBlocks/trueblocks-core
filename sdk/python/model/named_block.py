...
class NamedBlock(
    ...
    a block that has been given a particular name such as `first` or `latest`
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blockNumber", "timestamp", "date", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blockNumber", "timestamp", "date", "name", ], str]):
