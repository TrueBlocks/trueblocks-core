...
class Slurp(
    ...
    transaction data as returned from by Etherscan
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hash", "blockHash", "blockNumber", "transactionIndex", "nonce", "timestamp", "date", "from", "to", "value", "gas", "gasPrice", "input", "hasToken", "articulatedTx", "compressedTx", "isError", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hash", "blockHash", "blockNumber", "transactionIndex", "nonce", "timestamp", "date", "from", "to", "value", "gas", "gasPrice", "input", "hasToken", "articulatedTx", "compressedTx", "isError", ], str]):
