...
class Block(
    ...
    block data as returned from the RPC (with slight enhancements)
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["parentHash"]) -> MetaOapg.properties.parentHash: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["baseFeePerGas"]) -> MetaOapg.properties.baseFeePerGas: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["uncles"]) -> MetaOapg.properties.uncles: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["gasLimit", "hash", "blockNumber", "parentHash", "miner", "difficulty", "timestamp", "date", "transactions", "baseFeePerGas", "uncles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["parentHash"]) -> typing.Union[MetaOapg.properties.parentHash, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["miner"]) -> typing.Union[MetaOapg.properties.miner, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["baseFeePerGas"]) -> typing.Union[MetaOapg.properties.baseFeePerGas, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["uncles"]) -> typing.Union[MetaOapg.properties.uncles, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["gasLimit", "hash", "blockNumber", "parentHash", "miner", "difficulty", "timestamp", "date", "transactions", "baseFeePerGas", "uncles", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        parentHash: typing.Union[MetaOapg.properties.parentHash, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        miner: typing.Union[MetaOapg.properties.miner, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        difficulty: typing.Union[MetaOapg.properties.difficulty, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        transactions: typing.Union[MetaOapg.properties.transactions, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        baseFeePerGas: typing.Union[MetaOapg.properties.baseFeePerGas, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        uncles: typing.Union[MetaOapg.properties.uncles, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Block':
        return super().__new__(
