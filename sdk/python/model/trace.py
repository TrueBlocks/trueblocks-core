...
class Trace(
    ...
    trace data as returned from the RPC (with slight enhancements)
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            traceAddress = schemas.AnyTypeSchema
            ...
            articulatedTrace = schemas.AnyTypeSchema
            compressedTrace = schemas.AnyTypeSchema
            __annotations__ = {
                "blockHash": blockHash,
                ...
                "action": action,
                "result": result,
                "articulatedTrace": articulatedTrace,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["traceAddress"]) -> MetaOapg.properties.traceAddress: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subtraces"]) -> MetaOapg.properties.subtraces: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["articulatedTrace"]) -> MetaOapg.properties.articulatedTrace: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["compressedTrace"]) -> MetaOapg.properties.compressedTrace: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["blockHash", "blockNumber", "timestamp", "date", "transactionHash", "transactionIndex", "traceAddress", "subtraces", "type", "action", "result", "articulatedTrace", "compressedTrace", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["traceAddress"]) -> typing.Union[MetaOapg.properties.traceAddress, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subtraces"]) -> typing.Union[MetaOapg.properties.subtraces, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["articulatedTrace"]) -> typing.Union[MetaOapg.properties.articulatedTrace, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["compressedTrace"]) -> typing.Union[MetaOapg.properties.compressedTrace, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["blockHash", "blockNumber", "timestamp", "date", "transactionHash", "transactionIndex", "traceAddress", "subtraces", "type", "action", "result", "articulatedTrace", "compressedTrace", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        traceAddress: typing.Union[MetaOapg.properties.traceAddress, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        subtraces: typing.Union[MetaOapg.properties.subtraces, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        action: typing.Union[MetaOapg.properties.action, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        articulatedTrace: typing.Union[MetaOapg.properties.articulatedTrace, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        compressedTrace: typing.Union[MetaOapg.properties.compressedTrace, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Trace':
        return super().__new__(
