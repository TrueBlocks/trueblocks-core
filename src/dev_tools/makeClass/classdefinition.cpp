...
void CClassDefinition::registerClass(void) {
    ...
    ADD_FIELD(CClassDefinition, "short_fn", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "input_path", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "class_name", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "class_base", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "class_upper", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "base_class", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "base_name", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "base_proper", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "base_lower", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "base_upper", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "base_base", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "head_includes", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "src_includes", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "field_str", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "display_str", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "sort_str", T_TEXT, ++fieldNum);
    ADD_FIELD(CClassDefinition, "eq_str", T_TEXT, ++fieldNum);
...
const CBaseNode* CClassDefinition::getObjectAt(const string_q& fieldName, size_t index) const {
    if (fieldName % "fieldArray" && index < fieldArray.size())
