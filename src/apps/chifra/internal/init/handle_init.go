// TODO: BOGUS - TIMESTAMP IF USER DOES SCRAPE FROM SCRATCH, THEN INIT, THE TIMESTAMP FILE IS INCOMPLETE
// TODO: BOGUS - TIMESTAMP SOLUTION - INIT SHOULD DOWNLOAD TIMESTAMP AND REPLACE IF LATER
