...
import (
	...
	"github.com/TrueBlocks/trueblocks-core/src/apps/chifra/v6/pkg/sigintTrap"
...
func (opts *ScrapeOptions) HandleScrape(rCtx *output.RenderCtx) error {
	...
	for {
		...
		bm.blockCount = min(base.Blknum(opts.BlockCnt), bm.meta.ChainHeight()-bm.StartBlock()+1)
