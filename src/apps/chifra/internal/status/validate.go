...
func (opts *StatusOptions) validateStatus() error {
	...
	options := `[index|blooms|blocks|transactions|traces|logs|transfers|statements|results|state|tokens|monitors|names|abis|slurps|staging|unripe|maps|some|all]`
