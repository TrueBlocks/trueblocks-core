...
Flags:
  ...
  -X, --transfers           for the accounting options only, export only eth or token transfers
  -s, --assets              for the accounting options only, list all assets (with names) that appear in any transfer
  ...
  -P, --asset strings       for the accounting options only, export transfers, balances, or statements only for this asset
  -f, --flow string         for the accounting options only, export transfers, balances, or statements with incoming, outgoing, or zero value
                            One of [ in | out | zero ]
