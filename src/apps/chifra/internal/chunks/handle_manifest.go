...
func (opts *ChunksOptions) HandleManifest(blockNums []uint64) error {
	...
	if opts.Globals.Format == "txt" || opts.Globals.Format == "csv" {
		...
		err := opts.Globals.RenderHeader(types.SimpleChunkRecord{}, &opts.Globals.Writer, opts.Globals.Format, opts.Globals.ApiMode, !opts.Globals.ShowKeys, true)
		if err != nil {
			return err
		}
		...
		defer opts.Globals.RenderFooter()
		err = opts.Globals.RenderHeader(types.SimpleManifest{}, &opts.Globals.Writer, opts.Globals.Format, opts.Globals.ApiMode, !opts.Globals.ShowKeys, true)
		if err != nil {
			return err
		}
