...
func init() {
	...
	whenCmd.Flags().Uint64VarP(&whenPkg.GetOptions().Drop, "drop", "d", 0, "available only with --timestamps option, drops all timestamp records from this block on (inclusive) (hidden)")
