...
const notesScrape = `
Notes:
  - A maximum of 10,000 blocks will be processed at a time.`
...
func init() {
	...
	scrapeCmd.Flags().Uint64VarP(&scrapePkg.GetOptions().BlockCnt, "block_cnt", "n", 2000, "maximum number of blocks to process per pass (max 10,000)")
