...
// BEG_CODE_OPTIONS
    COption2("command", "", "<string>", OPT_REQUIRED, "one of [ leech | scrape | daemon | list | export | balances | stats | ls | rm | accounts | config | slurp | quotes | data | blocks | trans | receipts | logs | traces | state | abi ]"),
