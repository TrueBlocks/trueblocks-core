...
func Test_Bloom(t *testing.T) {
	tests := []struct {
		...
		{
			Addr:   base.HexToAddress("0x0371a82e4a9d0a4312f3ee2ac9c6958512891372"),
		...
		{
			Addr:   base.HexToAddress("0x3d493c51a916f86d6d1c04824b3a7431e61a3ca3"),
		...
		{
			Addr:   base.HexToAddress("0xe1c15164dcfe79431f8421b5a311a829cf0907f3"),
		...
		{
			Addr:   base.HexToAddress("0x1296d3bb6dc0efbae431a12939fc15b2823db49b"),
		...
		{
			Addr:   base.HexToAddress("0xd09022c48298f268c2c431dadb9ca4c2534d9c1c"),
		...
		{
			Addr:   base.HexToAddress("0x1296d3bb6dc0efbae431a12939fc15b2823db79b"),
		...
		{
			Addr:   base.HexToAddress("0xd09022c48298f268c2c431dadb9ca4c2534d9c1e"),
		...
		{
			Addr:   base.HexToAddress("0x0341a82e4a9d0a4312f3ee2ac9c6958512891342"),
		...
		{
			Addr:   base.HexToAddress("0x3d493c51a916f86d6d1c04824b3a4431e61a3ca3"),
		...
		{
			Addr:   base.HexToAddress("0xe1c15164dcfe49431f8421b5a311a829cf0904f3"),
	...
	for _, tt := range tests {
		...
		} else if !tt.Insert && bloom.isMemberBytes(tt.Addr) { // && !tt.FalsePositive {
