...
func TestSortByAddressAscending(t *testing.T) {
	abis := []Abi{
		{base.HexToAddress("0x2"), 2048, []Function{}, true, "2024-08-01", 10, 5, "AbiTwo", "/path/two"},
		{base.HexToAddress("0x3"), 4096, []Function{}, true, "2024-08-03", 12, 3, "AbiThree", "/path/three"},
		{base.HexToAddress("0x1"), 1024, []Function{}, false, "2024-08-02", 8, 6, "AbiOne", "/path/one"},
	}
