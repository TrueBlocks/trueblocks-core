...
func (s *SimpleStatement) Report(ctx Ledgerer, msg string) {
	logger.TestLog(true, "===================================================")
	...
	logger.TestLog(true, "   reconciliationType: ", s.ReconciliationType)
	...
	logger.TestLog(true, "   prevBal:            ", s.PrevBal.Text(10))
	logger.TestLog(true, "   begBal:             ", s.BegBal.Text(10))
	logger.TestLog(true, "   amountIn:           ", s.AmountIn.Text(10))
	logger.TestLog(true, "   internalIn:         ", s.InternalIn.Text(10))
	logger.TestLog(true, "   minerBaseRewardIn:  ", s.MinerBaseRewardIn.Text(10))
	logger.TestLog(true, "   minerNephewRewardIn:", s.MinerNephewRewardIn.Text(10))
	logger.TestLog(true, "   minerTxFeeIn:       ", s.MinerTxFeeIn.Text(10))
	logger.TestLog(true, "   minerUncleRewardIn: ", s.MinerUncleRewardIn.Text(10))
	logger.TestLog(true, "   correctingIn:       ", s.CorrectingIn.Text(10))
	logger.TestLog(true, "   prefundIn:          ", s.PrefundIn.Text(10))
	logger.TestLog(true, "   selfDestructIn:     ", s.SelfDestructIn.Text(10))
	logger.TestLog(true, "   totalIn:            ", s.TotalIn().Text(10))
	logger.TestLog(true, "   amountOut:          ", s.AmountOut.Text(10))
	logger.TestLog(true, "   internalOut:        ", s.InternalOut.Text(10))
	logger.TestLog(true, "   correctingOut:      ", s.CorrectingOut.Text(10))
	logger.TestLog(true, "   selfDestructOut:    ", s.SelfDestructOut.Text(10))
	logger.TestLog(true, "   gasOut:             ", s.GasOut.Text(10))
	logger.TestLog(true, "   totalOut:           ", s.TotalOut().Text(10))
	logger.TestLog(true, "   amountNet:          ", s.AmountNet().Text(10))
	logger.TestLog(true, "   endBal:             ", s.EndBal.Text(10))
	logger.TestLog(true, "   begBalDiff:         ", s.BegBalDiff().Text(10))
	logger.TestLog(true, "   endBalDiff:         ", s.EndBalDiff().Text(10))
	logger.TestLog(true, "   endBalCalc:         ", s.EndBalCalc().Text(10))
	logger.TestLog(true, "   correctingReason:   ", s.CorrectingReason)
	logger.TestLog(true, "   moneyMoved:         ", s.MoneyMoved())
	logger.TestLog(true, "   trialBalance:       ", s.Reconciled())
	logger.TestLog(true, "---------------------------------------------------")
}
