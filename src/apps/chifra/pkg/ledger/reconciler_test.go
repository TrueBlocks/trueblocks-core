...
func TestAssetOfInterest(t *testing.T) {
	...
	if !ledger2.AssetOfInterest(r1.assetFilter, needle) {
	...
	if !ledger2.AssetOfInterest(r2.assetFilter, needle2) {
	...
	if ledger2.AssetOfInterest(r3.assetFilter, needle3) {
	...
	if !ledger2.AssetOfInterest(r4.assetFilter, needle2) {
