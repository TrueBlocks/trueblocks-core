...
func (r *R econciler4) ProcessAppearance(blockNum base.Blknum, txIdx base.Txnum) error {
...
func newEthTransfer(holder base.Address, tx *types.Transaction) A ssetTransferNew {
	return A ssetTransferNew{
		Amount:           base.ZeroWei,
...
func (r *R econciler4) processETHTransfer(tx *types.Transaction) {
...
func (r *R econciler4) processTokenTransfers(receipt *types.Receipt, blockNum base.Blknum, timestamp base.Timestamp) {
...
func (r *R econciler4) processInternalTransfers(traces []types.Trace) {
...
func (r *R econciler4) ReconcileBlock(blockNum base.Blknum) error {
