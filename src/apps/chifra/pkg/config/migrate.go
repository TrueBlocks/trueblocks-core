...
var DesiredConfigVersion = "v1.6.0-release"
...
func migrate(currentVer version.Version) error {
	...
	if currentVer.Uint64() < v16000.Uint64() {
		...
		cfg.Unchained.Specification = "QmUou7zX2g2tY58LP1A2GyP5RF9nbJsoxKTp299ah3svgb"
		cfg.Unchained.HeaderMagic = "0x81ae14ba68e372bc9bd4a295b844abd8e72b1de10fcd706e624647701d911da1"
	}
