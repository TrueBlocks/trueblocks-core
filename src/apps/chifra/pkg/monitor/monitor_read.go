...
// ReadAppearancesAsMap reads all appearances from the monitor and returns a map of the appearances to the given type.
func ReadAppearancesAsMap[T any](mon *Monitor, filter *filter.AppearanceFilter) (theMap map[types.SimpleAppearance]*T, cnt int, err error) {
