...
bool COptions::parseArguments(string_q& command) {
    ...
    // TODO(tjayrush): We did this as part of the dAppNode docker hack. Without it, blockScrape
    // gets stuck when the dAppNode kills or pauses us
...
void COptions::Init(void) {
    ...
    minArgs       = 0;
    bitBound      = 200;
    maxIndexBytes = 20000000;  // 20 MB by default
}
