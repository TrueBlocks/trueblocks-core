...
// BEG_CODE_OPTIONS
    COption2("addr_list", "", "list<addr>", OPT_REQUIRED, "one or more addresses (0x...) to export"),
    ...
    COption2("blocks", "b", "<on/off>", OPT_HIDDEN, "write blocks to the binary cache ('off' by default)"),
