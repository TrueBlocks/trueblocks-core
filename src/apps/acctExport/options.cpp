...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("addr_list", "", "flag", true, true, "one or more addresses (0x...) to export"),
    COption2("fmt", "", "<fmt>", false, true, "export format (one of [json|txt|csv])"),
    COption2("articulate", "", "flag", false, true, "articulate transactions, traces, logs, and outputs"),
    COption2("logs", "", "flag", false, true, "export logs instead of transactions"),
    COption2("traces", "", "flag", false, true, "export traces instead of transactions"),
    COption2("blocks", "", "<on/off>", false, false, "write blocks to the binary cache ('off' by default)"),
    COption2("txs", "", "<on/off>", false, false, "write transactions to the binary cache ('on' by default)"),
    COption2("trc", "", "<on/off>", false, false, "write traces to the binary cache ('off' by default)"),
    COption2("ddos", "", "<on/off>", false, false, "skip over dDos transactions in export ('on' by default)"),
    COption2("maxTraces", "", "<num>", false, false, "if --ddos:on, the number of traces defining a dDos (default = 250)"),
    COption2("noHeader", "", "", false, false, "do not show the header row"),
    COption2("allABIs", "", "", false, false, "load all previously cached abi files"),
    COption2("grabABIs", "", "", false, false, "using each trace's 'to' address grab the abi for that address (improved articulation)"),
    COption2("start", "", "<num>", false, false, "first block to export (inclusive)"),
    COption2("end", "", "<num>", false, false, "last block to export (inclusive)"),
    COption2("", "", "", false, true, "Export full detail of transactions for one or more Ethereum addresses."),
