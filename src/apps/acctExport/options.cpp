...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("addr_list",	null,	"flag",	true,	true,	"one or more addresses (0x...) to export"),
ssssCOption2("fmt",	null,	"<fmt>",	false,	true,	"export format (one of [json|txt|csv])"),
ssssCOption2("articulate",	null,	"flag",	false,	true,	"articulate transactions, traces, logs, and outputs"),
ssssCOption2("logs",	null,	"flag",	false,	true,	"export logs instead of transactions"),
ssssCOption2("traces",	null,	"flag",	false,	true,	"export traces instead of transactions"),
ssssCOption2("blocks",	null,	"<on/off>",	false,	false,	"write blocks to the binary cache ('off' by default)"),
ssssCOption2("txs",	null,	"<on/off>",	false,	false,	"write transactions to the binary cache ('on' by default)"),
ssssCOption2("trc",	null,	"<on/off>",	false,	false,	"write traces to the binary cache ('off' by default)"),
ssssCOption2("ddos",	null,	"<on/off>",	false,	false,	"skip over dDos transactions in export ('on' by default)"),
ssssCOption2("maxTraces",	null,	"<num>",	false,	false,	"if --ddos:on, the number of traces defining a dDos (default = 250)"),
ssssCOption2("noHeader",	null,	"",	false,	false,	"do not show the header row"),
ssssCOption2("allABIs",	null,	"",	false,	false,	"load all previously cached abi files"),
ssssCOption2("grabABIs",	null,	"",	false,	false,	"using each trace's 'to' address grab the abi for that address (improved articulation)"),
ssssCOption2("start",	null,	"<num>",	false,	false,	"first block to export (inclusive)"),
ssssCOption2("end",	null,	"<num>",	false,	false,	"last block to export (inclusive)"),
ssssCOption2("",	null,	"",	false,	true,	"Export full detail of transactions for one or more Ethereum addresses."),
