...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("addr_list",	null,	"flag",	true,	true,	"one or more Ethereum addresses"),
ssssCOption2("noBlooms",	null,	"flag",	false,	false,	"turn off bloom filters for performance testing"),
ssssCOption2("staging",	null,	"flag",	false,	false,	"produce results in the staging folder instead of production folder"),
ssssCOption2("unripe",	null,	"flag",	false,	false,	"visit unripe (not old enough and not yet staged or finalized) blocks"),
ssssCOption2("daemon",	null,	"flag",	false,	false,	"we are being called in daemon mode which causes us to print results differently"),
ssssCOption2("start",	null,	"<num>",	false,	false,	"first block to check"),
