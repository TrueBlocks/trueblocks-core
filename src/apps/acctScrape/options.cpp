...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("addr_list", "", "flag", true, true, "one or more Ethereum addresses"),
    COption2("noBlooms", "", "flag", false, false, "turn off bloom filters for performance testing"),
    COption2("staging", "", "flag", false, false, "produce results in the staging folder instead of production folder"),
    COption2("unripe", "", "flag", false, false, "visit unripe (not old enough and not yet staged or finalized) blocks"),
    COption2("daemon", "", "flag", false, false, "we are being called in daemon mode which causes us to print results differently"),
    COption2("start", "", "<num>", false, false, "first block to check"),
