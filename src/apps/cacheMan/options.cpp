...
// BEG_CODE_OPTIONS
    ...
    COption2("fix", "f", "", OPT_FLAG, "remove duplicates from the cache (if any)"),
    COption2("list", "l", "", OPT_FLAG, "list the contents of the cache (the default if no other option)"),
    COption2("cacheBals", "a", "", OPT_FLAG, "cache per block account balances for each account"),
