...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("filenames",	null,	"flag",	true,	true,	"path(s) of files to check, merge, fix or display (default=display)"),
ssssCOption2("check",	null,	"flag",	false,	true,	"check for duplicates and other problems in the cache"),
ssssCOption2("data",	null,	"flag",	false,	true,	"in 'list' mode, render results as data (i.e export mode)"),
ssssCOption2("sort",	null,	"flag",	false,	true,	"sort the list of transactions and re-write (precludes other modes, other than --dedup)"),
ssssCOption2("fix",	null,	"flag",	false,	true,	"remove duplicates from the cache (if any)"),
ssssCOption2("list",	null,	"flag",	false,	true,	"list the contents of the cache (the default if no other option)"),
ssssCOption2("cacheBals",	null,	"flag",	false,	true,	"cache per block account balances for each account"),
ssssCOption2("balances",	null,	"flag",	false,	true,	"export account balances for each account"),
ssssCOption2("import",	null,	"flag",	false,	true,	"import transactions if import.txt file exists in current folder"),
ssssCOption2("remove",	null,	"flag",	false,	true,	"remove transactions if remove.txt file exists in current folder"),
ssssCOption2("truncate",	null,	"<num>",	false,	true,	"truncate the cache at block :n (keeps block 'n' and before, implies --fix)"),
ssssCOption2("maxBlock",	null,	"<num>",	false,	true,	"for testing, max block to visit"),
ssssCOption2("merge",	null,	"flag",	false,	true,	"merge two or more caches into a single cache"),
ssssCOption2("fmt",	null,	"<fmt>",	false,	true,	"export format (one of [json|txt|csv])"),
ssssCOption2("skip",	null,	"flag",	false,	false,	"skip value for testing"),
ssssCOption2("start",	null,	"<num>",	false,	false,	"un-used hidden value - do not remove"),
ssssCOption2("",	null,	"",	false,	true,	"Show the contents of an account cache and/or fix it by removing duplicate records.\n"),
