...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("filenames", "", "flag", true, true, "path(s) of files to check, merge, fix or display (default=display)"),
    COption2("check", "", "flag", false, true, "check for duplicates and other problems in the cache"),
    COption2("data", "", "flag", false, true, "in 'list' mode, render results as data (i.e export mode)"),
    COption2("sort", "", "flag", false, true, "sort the list of transactions and re-write (precludes other modes, other than --dedup)"),
    COption2("fix", "", "flag", false, true, "remove duplicates from the cache (if any)"),
    COption2("list", "", "flag", false, true, "list the contents of the cache (the default if no other option)"),
    COption2("cacheBals", "", "flag", false, true, "cache per block account balances for each account"),
    COption2("balances", "", "flag", false, true, "export account balances for each account"),
    COption2("import", "", "flag", false, true, "import transactions if import.txt file exists in current folder"),
    COption2("remove", "", "flag", false, true, "remove transactions if remove.txt file exists in current folder"),
    COption2("truncate", "", "<num>", false, true, "truncate the cache at block :n (keeps block 'n' and before, implies --fix)"),
    COption2("maxBlock", "", "<num>", false, true, "for testing, max block to visit"),
    COption2("merge", "", "flag", false, true, "merge two or more caches into a single cache"),
    COption2("fmt", "", "<fmt>", false, true, "export format (one of [json|txt|csv])"),
    COption2("skip", "", "flag", false, false, "skip value for testing"),
    COption2("start", "", "<num>", false, false, "un-used hidden value - do not remove"),
    COption2("", "", "", false, true, "Show the contents of an account cache and/or fix it by removing duplicate records.\n"),
