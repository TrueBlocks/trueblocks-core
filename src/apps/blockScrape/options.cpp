...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("nBlocks",	null,	"<num>",	false,	true,	"maximum number of blocks to process (defaults to 5000)"),
ssssCOption2("nBlockProcs",	null,	"<num>",	false,	false,	"number of block channels for blaze"),
ssssCOption2("nAddrProcs",	null,	"<num>",	false,	false,	"number of address channels for blaze"),
ssssCOption2("",	null,	"",	false,	true,	"Decentralized blockchain scraper and block cache."),
