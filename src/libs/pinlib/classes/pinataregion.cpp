...
//---------------------------------------------------------------------------
extern string_q nextPinataregionChunk(const string_q& fieldIn, const void* dataPtr);
...
//---------------------------------------------------------------------------------------------------
bool CPinataRegion::Migrate(CArchive& archiveIn, CArchive& archiveOut) const {
