...
void CReconciliationOutput::registerClass(void) {
    ...
    ADD_FIELD(CReconciliationOutput, "asset", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "begBal", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "begBalDiff", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "amountIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "amountOut", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "internalIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "internalOut", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "selfDestructIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "selfDestructOut", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "minerBaseRewardIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "minerNephewRewardIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "minerTxFeeIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "minerUncleRewardIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "prefundIn", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "gasCostOut", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "endBal", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "endBalCalc", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "endBalDiff", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "amountNet", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "reconciliationType", T_TEXT | TS_OMITEMPTY, ++fieldNum);
    ADD_FIELD(CReconciliationOutput, "reconciled", T_BOOL | TS_OMITEMPTY, ++fieldNum);
