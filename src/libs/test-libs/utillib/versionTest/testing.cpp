...
TEST_F(CThisTest, TestTest_1) {
    ...
    ASSERT_EQ("getVersionStr", getVersionStr(), "GHC-TrueBlocks//0.9.5-alpha--git-hash---git-ts-");
    ASSERT_EQ("getVersionStr", getVersionStr(false), "0.9.5-alpha--git-hash---git-ts-");
    ASSERT_EQ("getVersionStr", getVersionStr(false, false), "0.9.5-alpha");
    ASSERT_EQ("getVersionNum", getVersionNum(), 9005);
