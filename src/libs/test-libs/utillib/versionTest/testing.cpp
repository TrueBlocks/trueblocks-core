...
TEST_F(CThisTest, TestTest_1) {
    ...
    ASSERT_EQ("getVersionStr", getVersionStr(), "GHC-TrueBlocks//0.10.2-alpha--git-hash---git-ts-");
    ASSERT_EQ("getVersionStr", getVersionStr(false), "0.10.2-alpha--git-hash---git-ts-");
    ASSERT_EQ("getVersionStr", getVersionStr(false, false), "0.10.2-alpha");
    ASSERT_EQ("getVersionNum", getVersionNum(), 10002);
