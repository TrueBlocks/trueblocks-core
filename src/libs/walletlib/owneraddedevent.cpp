...
//---------------------------------------------------------------------------
IMPLEMENT_NODE(QOwnerAddedEvent, CLogEntry_Ex);
...
//---------------------------------------------------------------------------
void QOwnerAddedEvent::Format(ostream& ctx, const string_q& fmtIn, void *dataPtr) const {
    if (!m_showing)
        return;
...
//---------------------------------------------------------------------------------------------------
bool QOwnerAddedEvent::Serialize(CArchive& archive) {
...
//---------------------------------------------------------------------------------------------------
bool QOwnerAddedEvent::SerializeC(CArchive& archive) const {
...
//---------------------------------------------------------------------------
CArchive& operator>>(CArchive& archive, QOwnerAddedEventArray& array) {
    uint64_t count;
    archive >> count;
    array.resize(count);
...
//---------------------------------------------------------------------------
CArchive& operator<<(CArchive& archive, const QOwnerAddedEventArray& array) {
...
void QOwnerAddedEvent::registerClass(void) {
    ...
    ADD_FIELD(QOwnerAddedEvent, "cname", T_TEXT,  ++fieldNum);
...
//---------------------------------------------------------------------------
bool QOwnerAddedEvent::readBackLevel(CArchive& archive) {
