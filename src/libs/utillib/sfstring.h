...
//--------------------------------------------------------------------
inline string_q padNum2(uint64_t n) {
    return padLeft(uint_2_Str((n)), 2, '0');
}
inline string_q padNum3(uint64_t n) {
    return padLeft(uint_2_Str((n)), 3, '0');
}
inline string_q padNum4(uint64_t n) {
    return padLeft(uint_2_Str((n)), 4, '0');
}
inline string_q padNum5(uint64_t n) {
    return padLeft(uint_2_Str((n)), 5, '0');
}
inline string_q padNum6(uint64_t n) {
    return padLeft(uint_2_Str((n)), 6, '0');
}
inline string_q padNum7(uint64_t n) {
    return padLeft(uint_2_Str((n)), 7, '0');
}
inline string_q padNum8(uint64_t n) {
    return padLeft(uint_2_Str((n)), 8, '0');
}
inline string_q padNum9(uint64_t n) {
    return padLeft(uint_2_Str((n)), 9, '0');
}

//--------------------------------------------------------------------
inline string_q padNum2(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 2, '0');
}
inline string_q padNum3(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 3, '0');
}
inline string_q padNum4(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 4, '0');
}
inline string_q padNum5(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 5, '0');
}
inline string_q padNum6(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 6, '0');
}
inline string_q padNum7(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 7, '0');
}
inline string_q padNum8(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 8, '0');
}
inline string_q padNum9(uint32_t n) {
    return padLeft(uint_2_Str(uint64_t(n)), 9, '0');
}

//--------------------------------------------------------------------
inline string_q padNum2(int64_t n) {
    return padLeft(int_2_Str((n)), 2, '0');
}
inline string_q padNum3(int64_t n) {
    return padLeft(int_2_Str((n)), 3, '0');
}
inline string_q padNum4(int64_t n) {
    return padLeft(int_2_Str((n)), 4, '0');
}
inline string_q padNum5(int64_t n) {
    return padLeft(int_2_Str((n)), 5, '0');
}
inline string_q padNum6(int64_t n) {
    return padLeft(int_2_Str((n)), 6, '0');
}
inline string_q padNum7(int64_t n) {
    return padLeft(int_2_Str((n)), 7, '0');
}
inline string_q padNum8(int64_t n) {
    return padLeft(int_2_Str((n)), 8, '0');
}
inline string_q padNum9(int64_t n) {
    return padLeft(int_2_Str((n)), 9, '0');
}

//--------------------------------------------------------------------
inline string_q padNum2(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 2, '0');
}
inline string_q padNum3(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 3, '0');
}
inline string_q padNum4(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 4, '0');
}
inline string_q padNum5(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 5, '0');
}
inline string_q padNum6(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 6, '0');
}
inline string_q padNum7(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 7, '0');
}
inline string_q padNum8(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 8, '0');
}
inline string_q padNum9(int32_t n) {
    return padLeft(int_2_Str(int64_t(n)), 9, '0');
}
...
inline string_q padNum4T(uint64_t n) {
    return padLeft(uint_2_Str((n)), 4);
}
inline string_q padNum5T(uint64_t n) {
    return padLeft(uint_2_Str((n)), 5);
}
inline string_q padNum6T(uint64_t n) {
    return padLeft(uint_2_Str((n)), 6);
}
inline string_q padNum7T(uint64_t n) {
    return padLeft(uint_2_Str((n)), 7);
}
inline string_q padNum8T(uint64_t n) {
    return padLeft(uint_2_Str((n)), 8);
}
inline string_q padNum9T(uint64_t n) {
    return padLeft(uint_2_Str((n)), 9);
}
...
inline string_q padNum4T(int64_t n) {
    return padLeft(int_2_Str((n)), 4);
}
inline string_q padNum5T(int64_t n) {
    return padLeft(int_2_Str((n)), 5);
}
inline string_q padNum6T(int64_t n) {
    return padLeft(int_2_Str((n)), 6);
}
inline string_q padNum7T(int64_t n) {
    return padLeft(int_2_Str((n)), 7);
}
inline string_q padNum8T(int64_t n) {
    return padLeft(int_2_Str((n)), 8);
}
inline string_q padNum9T(int64_t n) {
    return padLeft(int_2_Str((n)), 9);
}
