...
public:
	...
	SFBigNumStore<BaseType>& operator=   ( const SFBigNumStore<BaseType>& x );
	                       ...
	                       SFBigNumStore ( unsigned int size );
...
//-------------------------------------------------------------------------------
template <class BaseType>
inline SFBigNumStore<BaseType>::SFBigNumStore(void)
: capacity(0), len(0)
{
	blk = 0;
}
...
//-------------------------------------------------------------------------------
template <class BaseType>
inline SFBigNumStore<BaseType>::SFBigNumStore(unsigned int c)
: capacity(c), len(0)
{
...
//-------------------------------------------------------------------------------
template <class BaseType>
SFBigNumStore<BaseType>::SFBigNumStore(const SFBigNumStore<BaseType> &x)
: len(x.len)
{
	capacity = len;
...
//-------------------------------------------------------------------------------
template <class BaseType>
SFBigNumStore<BaseType>::SFBigNumStore(const BaseType *b, unsigned int len)
