...
//---------------------------------------------------------------------------
IMPLEMENT_NODE(QApprovalEvent, CLogEntry_Ex);

//---------------------------------------------------------------------------
static string_q nextApprovaleventChunk(const string_q& fieldIn, const void *dataPtr);
...
//---------------------------------------------------------------------------
string_q nextApprovaleventChunk(const string_q& fieldIn, const void *dataPtr) {
    if (dataPtr)
        return reinterpret_cast<const QApprovalEvent *>(dataPtr)->getValueByName(fieldIn);
...
//---------------------------------------------------------------------------------------------------
bool QApprovalEvent::setValueByName(const string_q& fieldName, const string_q& fieldValue) {
    // EXISTING_CODE
    // EXISTING_CODE
...
void QApprovalEvent::registerClass(void) {
    ...
    ADD_FIELD(QApprovalEvent, "cname", T_TEXT,  ++fieldNum);
    ...
    HIDE_FIELD(QApprovalEvent, "cname");
...
string_q nextApprovaleventChunk_custom(const string_q& fieldIn, const void *dataPtr) {
    const QApprovalEvent *app = reinterpret_cast<const QApprovalEvent *>(dataPtr);
    if (app) {
...
//---------------------------------------------------------------------------
string_q QApprovalEvent::getValueByName(const string_q& fieldName) const {

    // Give customized code a chance to override first
    string_q ret = nextApprovaleventChunk_custom(fieldName, this);
    if (!ret.empty())
        return ret;
