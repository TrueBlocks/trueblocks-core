...
//---------------------------------------------------------------------------
static SFString nextApproveandcallChunk(const SFString& fieldIn, const void *dataPtr);
static SFString nextApproveandcallChunk_custom(const SFString& fieldIn, const void *dataPtr);

//---------------------------------------------------------------------------
void QApproveAndCall::Format(CExportContext& ctx, const SFString& fmtIn, void *dataPtr) const {
    if (!m_showing)
        return;
...
//---------------------------------------------------------------------------
SFString nextApproveandcallChunk(const SFString& fieldIn, const void *dataPtr) {
    if (dataPtr)
...
//---------------------------------------------------------------------------------------------------
bool QApproveAndCall::setValueByName(const SFString& fieldName, const SFString& fieldValue) {
    // EXISTING_CODE
    // EXISTING_CODE
...
//---------------------------------------------------------------------------
SFString nextApproveandcallChunk_custom(const SFString& fieldIn, const void *dataPtr) {
...
//---------------------------------------------------------------------------
bool QApproveAndCall::handleCustomFormat(CExportContext& ctx, const SFString& fmtIn, void *dataPtr) const {
    // EXISTING_CODE
    // EXISTING_CODE
    return false;
}
...
//---------------------------------------------------------------------------
SFString QApproveAndCall::getValueByName(const SFString& fieldName) const {

    // Give customized code a chance to override first
    SFString ret = nextApproveandcallChunk_custom(fieldName, this);
    if (!ret.empty())
        return ret;
