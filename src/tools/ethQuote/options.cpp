...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("at",	null,	"<timestamp>",	false,	true,	"Report the price since nearest five minutes to the given timestamp"),
ssssCOption2("current",	null,	"flag",	false,	true,	"Report on the current price (i.e. -at:now)"),
ssssCOption2("data",	null,	"flag",	false,	true,	"Export prices as JSON data"),
ssssCOption2("freshen",	null,	"flag",	false,	true,	"Freshen database (append new data)"),
ssssCOption2("period",	null,	"<5|15|30|*120|240|1440>",	false,	true,	"Display prices in this increment. One of [5|15|30|120*|240|1440]"),
ssssCOption2("pair",	null,	"<val>",	false,	true,	"Which price pair to freshen or list (see Poloniex)"),
ssssCOption2("",	null,	"",	false,	true,	"Freshen and/or display Ethereum price data and other purposes."),
