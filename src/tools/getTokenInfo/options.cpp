...
void COptions::loadTokenAbis(void) {
    standards.abi_spec.loadAbiFromFile(configPath("abis/known/erc_00020.json"), true);
    standards.abi_spec.loadAbiFromFile(configPath("abis/known/erc_00721.json"), true);
}
