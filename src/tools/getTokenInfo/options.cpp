...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("address_list",	null,	"flag",	true,	true,	"two or more addresses (0x...), the first is an ERC20 token, balances for the rest are reported"),
    ...
    COption2("byAcct",	null,	"flag",	false,	true,	"consider each address an ERC20 token except the last, whose balance is reported for each token"),
