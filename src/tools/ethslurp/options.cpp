...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("addrs",	null,	"flag",	true,	true,	"one or more addresses to slurp"),
ssssCOption2("blocks",	null,	"<range>",	false,	true,	"an optional range of blocks to slurp"),
ssssCOption2("type",	null,	"<tx_type>",	false,	true,	"extract either [ ext | int | token | miner | all ] type of transactions"),
ssssCOption2("fmt",	null,	"<str>",	false,	true,	"pretty print, optionally add ':txt,' ':csv,' or ':html'"),
ssssCOption2("blocks",	null,	"<range>",	false,	true,	"export records in block range (:0[:max])"),
ssssCOption2("silent",	null,	"flag",	false,	true,	"Run silently (only freshen the data, do not display it)"),
ssssCOption2("",	null,	"",	false,	true,	"Fetches data from EtherScan for an arbitrary address. Formats the output to your specification."),
