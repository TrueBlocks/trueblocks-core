...
ssssCOption2("logs",	null,	"flag",	false,	true,	"display the receipt's logs"),
ssssCOption2("fmt",	null,	"<fmt>",	false,	false,	"export format (one of [none|json|txt|csv|api])"),
ssssCOption2("",	null,	"",	false,	true,	"Retrieve a transaction's receipt from the local cache or a running node."),
    ...
    COption("-logs",           "display the receipt's logs"),
