...
//#define NEW_CODE
	...
	COption2("logs",	null,	"flag",	false,	true,	"display the receipt's logs"),
	COption2("fmt",	null,	"<fmt>",	false,	false,	"export format (one of [none|json|txt|csv|api])"),
	COption2("",	null,	"",	false,	true,	"Retrieve a transaction's receipt from the local cache or a running node.")
#else // NEW_CODE
