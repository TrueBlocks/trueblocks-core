...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("block_list",	null,	"flag",	true,	true,	"a space-separated list of one or more blocks to retrieve"),
ssssCOption2("hash_only",	null,	"flag",	false,	true,	"display only transaction hashes, default is to display full transaction detail"),
ssssCOption2("check",	null,	"flag",	false,	true,	"compare results between qblocks and Ethereum node, report differences, if any"),
ssssCOption2("addrs",	null,	"flag",	false,	true,	"display all addresses included in the block"),
ssssCOption2("uniq",	null,	"flag",	false,	true,	"display only uniq addresses found per block"),
ssssCOption2("uniqTx",	null,	"flag",	false,	true,	"display only uniq addresses found per transaction"),
ssssCOption2("number",	null,	"flag",	false,	true,	"display address counts (alterntively --addrCnt, --uniqTxCnt, or --uniqCnt)"),
ssssCOption2("filter",	null,	"<addr>",	false,	true,	"useful only for --addrs or --uniq, only display this address in results"),
ssssCOption2("latest",	null,	"flag",	false,	false,	"display the latest blocks at both the node and the cache"),
ssssCOption2("force",	null,	"flag",	false,	false,	"force a re-write of the block to the cache"),
ssssCOption2("quiet",	null,	"flag",	false,	false,	"do not print results to screen, used for speed testing and data checking"),
ssssCOption2("source",	null,	"[c|r]",	false,	false,	"either :c(a)che or :(r)aw, source for data retrival. (shortcuts -c = qblocks, -r = node)"),
ssssCOption2("fields",	null,	"[a|m|c|r]",	false,	false,	"either :(a)ll, (m)ini, (c)ache or :(r)aw; which fields to include in output (all is default)"),
ssssCOption2("normalize",	null,	"flag",	false,	false,	"normalize (remove un-common fields and sort) for comparison with other results (testing)"),
ssssCOption2("",	null,	"",	false,	true,	"Returns block(s) from local cache or directly from a running node."),
