...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("parse",	null,	"flag",	false,	true,	"display parsed input data"),
    COption2("logs",	null,	"flag",	false,	true,	"display smart contract lo(g)s or events"),
    COption2("trace",	null,	"flag",	false,	true,	"display smart contract internal traces"),
    COption2("accounting",	null,	"flag",	false,	true,	"display credits and debits per account and reconcile at each block"),
    COption2("no_check",	null,	"flag",	false,	true,	"do not do balance check at each block"),
    COption2("debug",	null,	"flag",	false,	true,	"enter debug mode (pause after each transaction)"),
    COption2("single",	null,	"flag",	false,	true,	"if debugging is enable, single step through transactions"),
    COption2("export",	null,	"flag",	false,	true,	"export the transactions to export file"),
    COption2("json",	null,	"flag",	false,	true,	"ignore export format and export as json"),
    COption2("bals",	null,	"flag",	false,	true,	"if a balance does not reconcile, export a message to a file"),
    COption2("list",	null,	"flag",	false,	true,	"display list of monitored accounts"),
