...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("parse", "", "flag", false, true, "display parsed input data"),
    COption2("logs", "", "flag", false, true, "display smart contract lo(g)s or events"),
    COption2("trace", "", "flag", false, true, "display smart contract internal traces"),
    COption2("accounting", "", "flag", false, true, "display credits and debits per account and reconcile at each block"),
    COption2("no_check", "", "flag", false, true, "do not do balance check at each block"),
    COption2("debug", "", "flag", false, true, "enter debug mode (pause after each transaction)"),
    COption2("single", "", "flag", false, true, "if debugging is enable, single step through transactions"),
    COption2("export", "", "flag", false, true, "export the transactions to export file"),
    COption2("json", "", "flag", false, true, "ignore export format and export as json"),
    COption2("bals", "", "flag", false, true, "if a balance does not reconcile, export a message to a file"),
    COption2("list", "", "flag", false, true, "display list of monitored accounts"),
    COption2("kBlock", "", "<num>", false, true, "start processing at block :k"),
    COption2("offset", "", "<num>", false, true, "offset to kBlock"),
    COption2("", "", "flag", false, true, "Index transactions for a given Ethereum address (or series of addresses)."),
#else // NEW_CODE
