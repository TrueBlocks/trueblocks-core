...
//#define NEW_CODE
#ifdef NEW_CODE
ssssCOption2("parse",	null,	"flag",	false,	true,	"display parsed input data"),
ssssCOption2("logs",	null,	"flag",	false,	true,	"display smart contract lo(g)s or events"),
ssssCOption2("trace",	null,	"flag",	false,	true,	"display smart contract internal traces"),
ssssCOption2("accounting",	null,	"flag",	false,	true,	"display credits and debits per account and reconcile at each block"),
ssssCOption2("no_check",	null,	"flag",	false,	true,	"do not do balance check at each block"),
ssssCOption2("debug",	null,	"flag",	false,	true,	"enter debug mode (pause after each transaction)"),
ssssCOption2("single",	null,	"flag",	false,	true,	"if debugging is enable, single step through transactions"),
ssssCOption2("export",	null,	"flag",	false,	true,	"export the transactions to export file"),
ssssCOption2("json",	null,	"flag",	false,	true,	"ignore export format and export as json"),
ssssCOption2("bals",	null,	"flag",	false,	true,	"if a balance does not reconcile, export a message to a file"),
ssssCOption2("list",	null,	"flag",	false,	true,	"display list of monitored accounts"),
ssssCOption2("kBlock",	null,	"<num>",	false,	true,	"start processing at block :k"),
ssssCOption2("offset",	null,	"<num>",	false,	true,	"offset to kBlock"),
ssssCOption2("",	null,	"flag",	false,	true,	"Index transactions for a given Ethereum address (or series of addresses)."),
