...
//#define NEW_CODE
#ifdef NEW_CODE
    COption2("addr_list", "", "flag", true, true, "list of one or more smart contracts whose ABI to grab from EtherScan"),
    COption2("canonical", "", "flag", false, true, "convert all types to their canonical represenation and remove all spaces from display"),
    COption2("generate", "", "flag", false, true, "generate C++ code into the current folder for all functions and events found in the ABI"),
    COption2("data", "", "flag", false, true, "export the display as data"),
    COption2("encode", "", "flag", false, true, "generate the encodings for the functions / events in the ABI"),
    COption2("json", "", "flag", false, true, "print the ABI to the screen as json"),
    COption2("noconst", "", "flag", false, true, "generate encodings for non-constant functions and events only (always true when generating)"),
    COption2("sol", "", "<fn>", false, true, "create the ABI file from a .sol file in the local directory"),
    COption2("open", "", "flag", false, false, "open the ABI file for editing, download if not already present"),
    COption2("silent", "", "flag", false, false, "if ABI cannot be acquired, fail silently (useful for scripting)"),
    COption2("nodec", "", "flag", false, false, "do not decorate duplicate names"),
    COption2("known", "", "flag", false, false, "load common 'known' ABIs from cache"),
    COption2("", "", "", false, true, "Fetches the ABI for a smart contract. Optionally generates C++ source code representing that ABI."),
#else // NEW_CODE
