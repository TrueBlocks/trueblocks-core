...
extern CArchive& operator>>(CArchive& archive, CDailySummaryArray& array);
extern CArchive& operator<<(CArchive& archive, const CDailySummaryArray& array);

//---------------------------------------------------------------------------
extern CArchive& operator<<(CArchive& archive, const CDailySummary& dai);
extern CArchive& operator>>(CArchive& archive, CDailySummary& dai);
