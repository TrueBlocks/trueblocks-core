...
# Create toml file only if it does not exist
#---------------------------------------------------------------
set(ETHSLURP_TOML_FILE "${QUICKBLOCKS_HOME}/ethslurp.toml")
if (NOT EXISTS "${ETHSLURP_TOML_FILE}")
    message(STATUS "Copying custom configuration file ${ETHSLURP_TOML_FILE}")
