contract A {
  event SafeReceived(address,uint256);
  function addTip(uint256,uint256) {}
  function submitMiningSolution(string,uint256,uint256) {}
  function depositEtherFor(address) {}
  function withdrawMany(uint64,address[]) {}
  function enterMarkets(address[]) {}
  function withdraw(uint64,address) {}
  ...
  function depositERC20ForUser(address,address,uint256) {}
  function depositFor(address,address,bytes) {}
  function sellToLiquidityProvider(address,address,address,address,uint256,uint256,bytes) {}
  function mintIdleToken(uint256,bool,address) {}
  function claim(uint256) {}
  function withdraw(address,uint256,address) {}
  function beginDispute(uint256,uint256,uint256) {}
  function enter(uint256) {}
  function deposit(address,uint256,uint16) {}
  function deposit(address,uint256,address,uint16) {}
  function bid(uint256,address,uint256) {}
  function redeemIdleToken(uint256) {}
  function depositGas() {}
  function createStake(address,uint256) {}
  function requestStakingWithdraw() {}
  function repay(address,uint256,uint256,address) {}
  function unlockDisputeFee(uint256) {}
