...
replace github.com/TrueBlocks/trueblocks-core/src/apps/chifra => ../../apps/chifra

require github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20240221021507-efd334ebc492
