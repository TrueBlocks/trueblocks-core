...
public:
    address_t singularDTVCrowdfundingAddress;
    address_t singularDTVTokenAddress;
...
inline void CSetup::initialize(void) {
    ...
    singularDTVCrowdfundingAddress = "";
...
inline void CSetup::duplicate(const CSetup& se) {
    ...
    singularDTVCrowdfundingAddress = se.singularDTVCrowdfundingAddress;
    singularDTVTokenAddress = se.singularDTVTokenAddress;
