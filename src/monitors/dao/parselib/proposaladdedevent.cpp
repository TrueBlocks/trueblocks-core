...
bool CProposalAddedEvent::setValueByName(const string_q& fieldName, const string_q& fieldValue) {
    ...
    switch (tolower(fieldName[0])) {
        ...
        case 'd':
            ...
            break;
        case 'n':
            if ( fieldName % "newCurator" ) { newCurator = str_2_Bool(fieldValue); return true; }
            break;
        case 'p':
...
void CProposalAddedEvent::registerClass(void) {
    ...
    ADD_FIELD(CProposalAddedEvent, "newCurator", T_BOOL, ++fieldNum);
...
string_q CProposalAddedEvent::getValueByName(const string_q& fieldName) const {
    ...
    switch (tolower(fieldName[0])) {
        ...
        case 'd':
            ...
            break;
        case 'n':
            if ( fieldName % "newCurator" ) return int_2_Str(newCurator);
            break;
        case 'p':
