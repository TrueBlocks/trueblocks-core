module github.com/TrueBlocks/trueblocks-core/examples/keystore
...
require (
	...
	github.com/TrueBlocks/trueblocks-core/src/apps/chifra v0.0.0-20241103193928-2a3d9f89af63 // indirect
