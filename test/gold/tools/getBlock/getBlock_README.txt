...
| -s | --source [c|r] | either :c(a)che or :(r)aw, source for data retrival. (shortcuts -k = qblocks, -r = node) |
| -f | --fields [a|m|c|r] | either :(a)ll, (m)ini, (c)ache or :(r)aw; which fields to include in output (all is default) |
