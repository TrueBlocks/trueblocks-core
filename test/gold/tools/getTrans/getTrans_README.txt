...
| -b | --belongs val | report true of false if the given address is found anywhere in the transaction |
| -a | --asStrs | when checking --belongs, treat input and log data as single string |
