...
| blockNumber         | the number of the block                                                                                                           | blknum    |
| transactionIndex    | the zero-indexed position of the transaction in the block                                                                         | blknum    |
| logIndex            | the zero-indexed position the log in the block                                                                                    | blknum    |
...
| decimals            | Equivalent to the extracted value of `decimals` from an ERC20 contract or, if ETH or WEI then 18                                  | uint64    |
...
| encoding            | One of `regular`, `traces`, `prevdiff-partial`, `partial-nextdiff`, or `partial-partial`                                          | string    |
| signature           | One of `regular`, `traces`, `prevdiff-partial`, `partial-nextdiff`, or `partial-partial`                                          | string    |
...
| totalOutLessGas     | a calculated field -- totalOut - gasCostOut                                                                                       | int256    |
