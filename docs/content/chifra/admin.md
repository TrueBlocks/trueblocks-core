...
| ------------------ | ------------ | ------------ | --------- |
| apps&lowbar;per&lowbar;chunk | uint64       | 500000       | the number of appearances to build into a chunk before consolidating it |
...
| first&lowbar;snap  | uint64       | 500000       | the first block at which snap_to_grid is enabled |
